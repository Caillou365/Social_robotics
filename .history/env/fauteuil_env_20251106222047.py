...
class FauteuilEnv(gym.Env):
    def __init__(self, config):
        ...
        self.robot_pos = np.array([1.0, 1.0], dtype=np.float32)  # Position initiale
        self.goal_pos = np.array([8.0, 8.0], dtype=np.float32)  # Position du but
        self.max_speed = 0.5
    ...
    def render(self):
        ...
        # Dessine le but (vert) - Rayon plus grand pour mieux voir
        pygame.draw.circle(
            self.screen,
            (0, 255, 0),
