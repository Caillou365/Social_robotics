...
# Initialise Pygame AU DÉBUT du programme
pygame.init()
...
obs, _ = env.render()  # Force l'initialisation de l'affichage
...
try:
    ...
    while running:
        ...
        for event in pygame.event.get():  # Doit fonctionner maintenant
